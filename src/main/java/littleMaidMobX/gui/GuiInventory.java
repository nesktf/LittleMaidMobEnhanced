...
public class GuiInventory extends GuiContainer {
	...
	protected static final ResourceLocation fguiTex =
			new ResourceLocation(LittleMaidMobX.DOMAIN, "textures/gui/container/littlemaidinventory.png");
...
//		int var9 = var7.getPrevFoodLevel();
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		case 200:
			...
			mc.displayGuiScreen(new GuiTextureSelectBase(this, entitylittlemaid, ldye, true));
		}
	}
	...
	private void displayDebuffEffects() {
		...
		for (Iterator iterator = entitylittlemaid.getActivePotionEffects().iterator(); iterator.hasNext();) {
			...
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			ClientHelper.setTexture(field_147001_a);
