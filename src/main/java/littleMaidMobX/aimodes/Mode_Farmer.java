 ...
 *
 */
public class Mode_Farmer extends ModeBase {
	...
	public Mode_Farmer(EntityLittleMaid pEntity) {
		super(pEntity);
		TriggerSelect.appendTriggerItem(null, "Hoe", "");
		TriggerSelect.appendTriggerItem(null, "Seeds", "");
...
//			return true;
	...
	public void updateAITick(int pMode) {
		...
		/*if(pMode==Mode_Basic.mmode_FarmPorter &&
	...
	protected int getHadSeedIndex(){
		int r=-1;
		for(Item item : TriggerSelect.getuserTriggerList(null, "Seeds")){
